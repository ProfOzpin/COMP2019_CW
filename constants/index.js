...
export const navLinks = [
  {
    id: "help",
    title: "Help",
    link: "/help", // Changed to lowercase for Next.js
  },
];

// Keep all your other constants exactly the same...
export const features = [
  {
    id: "feature-1",
    title: "When was this application built?",
    content: "This application was built in 2023 as part of our module, Software Engineering Group Project.",
  },
  {
    id: "feature-2", 
    title: "Who are the team members involved in the development of this application?",
    content: "Our team consists of 5 Computer Science students from the University of Nottingham Malaysia, supervised by Mr Chew Sze Ker.",
  },
  {
    id: "feature-3",
    title: "What concept does the Imag.e system use to detect and recognise faces?",
    content: "The system uses Histogram of Oriented Gradients to extract the features of the individual found in the image uploaded by user.",
  },
  {
    id: "feature-4",
    title: "How to use this Imag.e application to detect faces?",
    content: "Navigate to the function page by clicking the 'Get Started' button. Upload an image of only 1 individual.",
  },
];
...
export const footerLinks = [
  {
    ...
    links: [
      ...
      {
        name: "How it Works",
        link: "/help", // Updated to lowercase
      },
      {
        name: "Explore", 
        link: "/help", // Updated to lowercase
